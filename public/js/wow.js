(function() {
  ...
  this.WOW = (function() {
    ...
    WOW.prototype.init = function(container) {
      var _ref;
      this.element = container == window.document 
        ? container.documentElement
        : container;
      if ((_ref = document.readyState) === "interactive" || _ref === "complete") {
        this.start(container);
      } else {
        this.util().addEvent(document, 'DOMContentLoaded', this.start(container));
      }
      return this.finished = [];
    };

    WOW.prototype.start = function(container) {
      ...
      if (!this.disabled()) {
        this.util().addEvent(container, 'scroll', this.scrollHandler);
        this.util().addEvent(container, 'resize', this.scrollHandler);
